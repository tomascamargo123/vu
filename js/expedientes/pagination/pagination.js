...
var Pagination = function (el, options) {
	...
	getRenderedPageRange = function () {
		var result = '<select class="page-range" style="float: right; margin-top: -40px;">';
	...
	getRenderedPageNumbers = function () {
		...
		result = '<li data-page="' + FIRST_PAGE_NUMBER + '" class="page-item"><a class="page-link" href="javascipt:void(0)"><span aria-hidden="true">' + firstPageLabel + '</span></a></li>' +
				 '<li data-page="' + PREVIOUS_PAGE_NUMBER + '" class="page-item"><a class="page-link" href="javascipt:void(0)"><span aria-hidden="true">' + previousPageLabel + '</span></a></li>';

		$.each(pageNumbers, function (i, p) {
			result += '<li data-page="' + p + '" ' + (p === currentPage ? 'class="page-item active"' : '"page-item"') + '><a class="page-link" href="javascipt:void(0)">' + p + '</a></li>';
		});

		result += '<li data-page="' + NEXT_PAGE_NUMBER + '" class="page-item"><a class="page-link" href="javascipt:void(0)"><span aria-hidden="true">' + nextPageLabel + '</span></a></li>' +
				  '<li data-page="' + LAST_PAGE_NUMBER + '" class="page-item"><a class="page-link" href="javascipt:void(0)"><span aria-hidden="true">' + lastPageLabel + '</span></a></li>';
