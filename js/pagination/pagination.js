...
var Pagination = function (el, options) {
	...
	getRenderedPager = function () {
		return '<ul class="pagination">' + getRenderedPageNumbers() +  getRenderedPageRange()+'</ul>' ;
	};

	getRenderedPageRange = function () {
		var result = '<select class="page-range " style="left: right;height: 34px;margin:0px 20px;">';
