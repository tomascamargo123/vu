		...
		<div class="row">
            <div class="col-xs-12">
				<div class="box box-primary">
					...
					<div class="box-body">
						<a class="btn btn-app btn-app-zetta <?php echo $class['agregar']; ?>" href="usuarios/agregar">
							<i class="fa fa-plus" id="btn-agregar"></i> Agregar
						</a>
						<a class="btn btn-app btn-app-zetta <?php echo $class['ver']; ?>" href="usuarios/ver/<?php echo (!empty($usuario->id)) ? $usuario->id : ''; ?>">
							<i class="fa fa-search" id="btn-ver"></i> Ver
						</a>
						<a class="btn btn-app btn-app-zetta <?php echo $class['editar']; ?>" href="usuarios/editar/<?php echo (!empty($usuario->id)) ? $usuario->id : ''; ?>">
							<i class="fa fa-edit" id="btn-editar"></i> Editar
						</a>
						<a class="btn btn-app btn-app-zetta <?php echo $class['eliminar']; ?>" href="usuarios/eliminar/<?php echo (!empty($usuario->id)) ? $usuario->id : ''; ?>">
