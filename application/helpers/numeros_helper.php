 ...
 */
function num_to_letras($numero, $moneda = '', $subfijo = 'centavos')
{
    $xarray = array(
        0 => 'Cero'
    ...
    for ($xz = 0; $xz < 3; $xz++) {
        ...
        if ('' != trim($xaux)) {
            switch ($xz) {
                ...
                case 2:
                    if (1 > $numero) {
                        $xcadena = "CERO con {$xdecimales}/100 {$subfijo}";
                    }
                    if ($numero >= 1 && $numero < 2) {
                        $xcadena = "UNO con {$xdecimales}/100 {$subfijo}";
                    }
                    if ($numero >= 2) {
                        $xcadena.= " con {$xdecimales}/100 {$subfijo}"; //
                    }
                    break;
            } // endswitch ($xz)
        } // ENDIF (trim($xaux) != "")
    ...
    return substr(trim($xcadena),0,1).strtolower(substr(trim($xcadena),1));
}
