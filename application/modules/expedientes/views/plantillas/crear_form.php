            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <h4 class="box-title">Editar formulario.</h4>
                        <!--  -->
                        <div id="app">
                            <!--                            <div>
                                                            {{ $data | json }}
                            ...
                            <button class="btn btn-primary" v-if="elemyform.length > 0" v-on:click="guardarFormulario()">Guardar</button>
                        </div>
                    </div>
                    <!-- fin de mi codigo -->
                </div> 
    ...
    methods: {
        ...
        guardarFormulario: function(){
            ...
            if(campo_key && this.formname != ''){
                axios.post(
                    "<?= base_url('expedientes/plantillas/crear_formulario_back');?>",
                    {
