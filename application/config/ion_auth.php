 ...
 */
$config['site_title']                 = "Municipalidad de Lavalle";			// Site Title, example.com
$config['admin_email']                = "modernizacionlavalle@gmail.com"; // Admin Email, admin@example.com
 ...
 */
$config['remember_cookie_name'] = 'remember_lavalle';
$config['identity_cookie_name'] = 'identity_lavalle';
